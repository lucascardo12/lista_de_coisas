...
class _ListasPageState extends State<ListasPage> {
  ...
  void criaCoisa() {
    ...
    Fluttertoast.showToast(
        msg: this.coisas != null ? "Alterado com Sucesso!!" : "Criado com Sucesso!!",
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
              IconButton(
                ...
                onPressed: () {
                  Navigator.pop(context, this.coisas != null ? this.coisas : null);
                },
              ),
              SizedBox(
                width: 15,
                ...
                children: [
                  ...
                  TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        labelText: tituloControler.text.isEmpty ? "Digite um Titulo" : null,
